...
export function Header({ locale, currentPath = '/' }: HeaderProps) {
  ...
  const groups: MenuGroup[] = [
    ...
    { label: labels.privateAccess, href: linkTo('private-club'), items: [
      ...
      { label: 'The Peninsula Istanbul', href: peninsulaLink, description: locale === 'fr' ? 'Adresse membre Bosphoras Premium à Istanbul.' : locale === 'en' ? 'Bosphoras Premium member address in Istanbul.' : locale === 'ru' ? 'Адрес участника Bosphoras Premium в Стамбуле.' : 'عنوان عضو Bosphoras Premium في إسطنبول.' },
