...
function clusterByTitle(locale: TransferLocale, titlePart: string) {
  return (transferKeywordClusters[locale] || []).find((group) => group.title.toLowerCase().includes(titlePart.toLowerCase()))?.terms || [];
}
