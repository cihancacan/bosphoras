...
const paths: Record<Locale, string> = {
  ...
  en: '/en/expat-tax-turkey-foreign-income',
  ru: '/ru/nalogi-dlya-ekspatov-v-turtsii-inostrannye-dohody',
  ar: '/ar/turkey-tax-for-arab-investors-foreign-income',
};
...
const content: Record<Locale, PageContent> = {
  fr: {
    ...
    faq: [['Un Français peut-il devenir résident fiscal en Turquie ?', 'Oui, mais cela dépend de la réalité de son installation et de sa situation en France. Il faut analyser foyer, activité, intérêts économiques, sociétés, immobilier et convention fiscale France-Turquie.'], ['Faut-il vendre son immobilier en France avant de partir ?', 'Pas forcément. Mais l’immobilier français peut conserver un lien fiscal fort avec la France. Les loyers, plus-values et obligations déclaratives doivent être analysés.'], ['Les dividendes d’une société française peuvent-ils être exonérés en Turquie ?', 'Potentiellement selon le texte final turc et le profil, mais la France peut conserver une retenue ou un droit d’imposition. La convention fiscale doit être étudiée.'], ['Un retraité français peut-il vivre en Turquie ?', 'Oui, mais la pension, l’assurance santé, la couverture médicale, le logement et la convention fiscale doivent être étudiés avant l’installation.'], ['Bosphoras donne-t-il un conseil fiscal ?', 'Non. Bosphoras coordonne l’analyse privée et les bons interlocuteurs : fiscalistes, avocats, banques, comptables, assurance et partenaires d’installation en Turquie.']],
  },
  en: {
    title: 'Expat Tax in Turkey: foreign income, tax residence and relocation planning',
    metaTitle: 'Expat Tax Turkey: Foreign Income & Tax Residence Guide 2026',
    description: 'Guide for expats considering Turkey: tax residence, foreign income, companies, dividends, capital gains, property, pensions and relocation planning.',
    eyebrow: 'Expat tax · Turkey',
    hero: 'Turkey is becoming an attractive base for expats, entrepreneurs, investors, remote executives and international families. Before relocating, the key question is not only where you want to live, but how your tax residence, foreign income, companies and assets will be treated.',
    ...
    sections: [
      ...
      ['How Bosphoras supports expats', 'Bosphoras acts as a private coordination desk. It does not replace tax counsel, but it helps prepare the file, identify sensitive points and coordinate tax advisors, lawyers, banks, accountants, insurers, real estate and relocation partners in Turkey. The goal is to decide whether Turkey can be a serious, compliant and practical base for you and your family.'],
    ],
    faq: [['Can an expat become tax resident in Turkey?', 'Yes, but the result depends on real life, family, days of presence, income, companies, assets and the tax treaty with the former country.'], ['Does a Turkish residence permit automatically change my tax residence?', 'No. A residence permit is not enough. Tax residence depends on factual and legal criteria.'], ['Can foreign dividends be treated favorably in Turkey?', 'Potentially, depending on the final Turkish rules, the source country, withholding tax, treaty position and timing.'], ['Can I keep my foreign company while living in Turkey?', 'Potentially, but effective management, contracts, clients, substance and distributions must be reviewed.'], ['Does Bosphoras provide tax advice?', 'No. Bosphoras coordinates the private review and connects clients with suitable tax advisors, lawyers, banks and relocation partners.']],
  },
  ru: {
    title: 'Налоги для экспатов в Турции: иностранные доходы и налоговая резиденция',
    metaTitle: 'Налоги для экспатов в Турции: иностранные доходы 2026',
    ...
    faq: [['Может ли русскоязычный инвестор стать налоговым резидентом Турции?', 'Да, но это зависит от реальной жизни, семьи, сроков пребывания, активов, доходов, компаний и налоговых правил прежней страны.'], ['ВНЖ в Турции автоматически меняет налоговую резиденцию?', 'Нет. ВНЖ помогает с проживанием, но налоговая резиденция зависит от фактических и юридических критериев.'], ['Можно ли сохранить иностранную компанию?', 'Потенциально да, но нужно анализировать фактическое управление, клиентов, договоры, счета, дивиденды и налоговые соглашения.'], ['Что важно для банков в Турции?', 'Банки обычно смотрят источник средств, налоговую резиденцию, структуру бизнеса, документы, происхождение капитала и compliance-профиль клиента.'], ['Bosphoras дает налоговую консультацию?', 'Нет. Bosphoras координирует частный анализ и связывает клиента с налоговыми специалистами, юристами, банками и партнерами по переезду.']],
  },
  ar: {
    title: 'ضرائب تركيا للمستثمرين العرب: الدخل الأجنبي والإقامة الضريبية',
    metaTitle: 'ضرائب تركيا للمستثمرين العرب: الدخل الأجنبي 2026',
    ...
    faq: [['هل يمكن للمستثمر العربي أن يصبح مقيماً ضريبياً في تركيا؟', 'نعم، لكن ذلك يعتمد على مكان الحياة الفعلية، العائلة، الدخل، الشركات، الأصول، عدد أيام الإقامة والاتفاقيات الضريبية.'], ['هل شراء عقار في تركيا يكفي لتغيير الإقامة الضريبية؟', 'لا. شراء العقار قد يساعد في الإقامة القانونية أو نمط الحياة، لكنه لا يكفي وحده لتحديد الإقامة الضريبية.'], ['هل يمكن الاحتفاظ بشركة في الخليج أثناء العيش في تركيا؟', 'محتمل، لكن يجب مراجعة الإدارة الفعلية، العملاء، العقود، الحسابات، توزيع الأرباح والاتفاقيات الضريبية.'], ['هل الدخل من الخليج يعتبر دخلاً أجنبياً في تركيا؟', 'قد يكون كذلك، لكن يجب تحليل نوع الدخل، بلد المصدر، الاتفاقية الضريبية، الضريبة المقتطعة وتوقيت الانتقال.'], ['هل يقدم Bosphoras استشارة ضريبية؟', 'لا. Bosphoras ينسق المراجعة الخاصة ويربط العميل بالمستشارين الضريبيين والمحامين والبنوك وشركاء الانتقال المناسبين.']],
  },
};

export function getMarketExpatTurkeyTaxMetadata(locale: Locale): Metadata {
  const c = content[locale];
  const canonical = `https://bosphoras.com${paths[locale]}`;
  return { title: `${c.metaTitle} | Bosphoras`, description: c.description, alternates: { canonical, languages: { fr: `https://bosphoras.com${paths.fr}`, en: `https://bosphoras.com${paths.en}`, ru: `https://bosphoras.com${paths.ru}`, ar: `https://bosphoras.com${paths.ar}`, 'x-default': `https://bosphoras.com${paths.fr}` } }, openGraph: { title: c.title, description: c.description, url: canonical, siteName: 'Bosphoras', type: 'article', images: [{ url: '/images/og-default.jpg', width: 1200, height: 630, alt: c.title }] }, twitter: { card: 'summary_large_image', title: c.title, description: c.description, images: ['/images/og-default.jpg'] } };
}

export function MarketExpatTurkeyTaxClientPage({ locale }: { locale: Locale }) {
  const c = content[locale];
  return (
    <>
      ...
      <main dir={locale === 'ar' ? 'rtl' : 'ltr'} className="bg-[#f8f1e7] text-[#101827]">
        <section className="bg-[#121826] px-5 pb-20 pt-32 text-white md:px-8 md:pt-40"><div className="mx-auto max-w-[1400px]"><p className="text-xs font-bold uppercase tracking-[0.28em] text-[#d2a863]">{c.eyebrow}</p><h1 className="mt-6 max-w-6xl font-serif text-4xl leading-[1.05] tracking-[-0.045em] md:text-7xl">{c.title}</h1><p className="mt-8 max-w-4xl text-lg leading-9 text-white/80">{c.hero}</p><Link href={assessmentHref[locale]} className="mt-10 inline-flex items-center justify-center gap-3 bg-[#d2a863] px-8 py-4 text-xs font-bold uppercase tracking-[0.16em] text-[#101827]">{c.cta}<ArrowRight size={16} /></Link></div></section>
        <section className="px-5 py-16 md:px-8 md:py-24"><div className="mx-auto grid max-w-[1400px] gap-8 lg:grid-cols-[0.75fr_1.25fr]"><aside className="h-fit border border-[#d8c7a1] bg-[#fffaf0] p-8 lg:sticky lg:top-28"><Landmark className="h-8 w-8 text-[#8a6728]" /><h2 className="mt-6 font-serif text-3xl">{c.asideTitle}</h2><ul className="mt-6 space-y-3 text-sm leading-7 text-[#3e4857]">{c.checklist.map((item) => <li key={item} className="flex gap-3"><CheckCircle2 className="mt-1 h-4 w-4 shrink-0 text-[#8a6728]" />{item}</li>)}</ul></aside><div className="space-y-5">{c.sections.map(([sectionTitle, text], index) => <article key={sectionTitle} className="border border-[#d8c7a1] bg-white p-7 md:p-9"><p className="text-xs font-bold uppercase tracking-[0.22em] text-[#8a6728]">{String(index + 1).padStart(2, '0')}</p><h2 className="mt-4 font-serif text-3xl tracking-[-0.025em] text-[#121826] md:text-4xl">{sectionTitle}</h2><p className="mt-5 text-base leading-8 text-[#3e4857]">{text}</p></article>)}</div></div></section>
        <section className="bg-[#fffaf0] px-5 py-16 md:px-8 md:py-24"><div className="mx-auto max-w-[1100px]"><ShieldCheck className="h-8 w-8 text-[#8a6728]" /><h2 className="mt-6 font-serif text-4xl tracking-[-0.03em] md:text-6xl">{c.finalTitle}</h2><p className="mt-6 text-lg leading-9 text-[#3e4857]">{c.finalText}</p><Link href={assessmentHref[locale]} className="mt-8 inline-flex items-center justify-center gap-3 bg-[#121826] px-8 py-4 text-xs font-bold uppercase tracking-[0.16em] text-white">{c.cta}<ArrowRight size={16} /></Link></div></section>
        <section className="px-5 py-16 md:px-8 md:py-24"><div className="mx-auto max-w-[1100px]"><FileText className="h-8 w-8 text-[#8a6728]" /><h2 className="mt-6 font-serif text-4xl tracking-[-0.03em]">{c.faqTitle}</h2><div className="mt-8 grid gap-px bg-[#d8c7a1]">{c.faq.map(([q, a]) => <article key={q} className="bg-[#f8f1e7] p-7"><h3 className="font-serif text-2xl text-[#121826]">{q}</h3><p className="mt-4 leading-8 text-[#3e4857]">{a}</p></article>)}</div></div></section>
      </main>
