...
const copies: Record<Locale, Copy> = {
  ...
  ru: {
    ...
    needs: [
      ...
      'Недвижимость и relocation',
      'Частные или shared офисы',
      'VIP transport и hospitality',
      'Отели, яхты, мероприятия',
      'Private access и membership',
    ],
    methodEyebrow: 'Метод',
  ...
  ar: {
    ...
    needs: [
      ...
      'الصحة والتأمين',
      'العقار وrelocation',
      'مكاتب خاصة أو مشتركة',
      'النقل VIP وhospitality',
      'فنادق، يخوت، فعاليات',
      'الوصول الخاص والعضوية',
    ],
...
export function buildPrivateAssessmentMetadata(locale: Locale): Metadata {
  const title = locale === 'fr'
    ? 'Contact privé | Diagnostic Bosphoras'
    : locale === 'en'
      ? 'Private Contact | Bosphoras Assessment'
      : locale === 'ru'
        ? 'Частный контакт | Консультация Bosphoras'
        : 'تواصل خاص | تقييم Bosphoras';
  ...
  const description = locale === 'fr'
    ...
    : locale === 'en'
      ? 'Contact Bosphoras for a private assessment in Turkey: relocation, tax, company, healthcare, insurance, property, offices, VIP transport, hotels, events and private access.'
      : locale === 'ru'
        ? 'Свяжитесь с Bosphoras для частной консультации по Турции: переезд, налоги, компания, здоровье, страхование, недвижимость, офисы, VIP transport, отели, мероприятия и private access.'
        : 'تواصلوا مع Bosphoras للحصول على تقييم خاص في تركيا: الانتقال، الضرائب، الشركة، الصحة، التأمين، العقار، المكاتب، النقل VIP، الفنادق، الفعاليات والوصول الخاص.';
