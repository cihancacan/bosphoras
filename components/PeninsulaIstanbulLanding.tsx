...
export const peninsulaCopy = {
  fr: {
    ...
    eyebrow: 'Bosphoras Premium Members', title: 'Accès premium au Peninsula Istanbul',
    ...
    join: 'Demander une adhésion', back: 'Retour Bosphoras', why: 'Pourquoi cette adresse', memory: 'La meilleure vue d’Istanbul n’est pas seulement une vue. C’est une mémoire.',
    whyText: 'Depuis Karaköy, le regard traverse les siècles : Galata, les routes marchandes, Byzance, Constantinople, la conquête ottomane et l’Istanbul contemporaine.',
    choiceLabel: 'Le choix Bosphoras', choiceTitle: 'Faire partie d’Istanbul, pas seulement y séjourner.',
    choiceText1: 'Nous n’avons pas choisi le Peninsula uniquement pour son confort. Nous l’avons choisi parce qu’il se trouve à Karaköy, l’ancienne Galata, face à la péninsule historique, entre la Corne d’Or et le Bosphore.',
    choiceText2: 'Depuis cette rive, on comprend pourquoi Istanbul a attiré les Romains, les Byzantins, les Génois, les Ottomans, les marchands, les ambassadeurs et les puissances du monde. Pour un membre Bosphoras, cette adresse devient un point d’ancrage au cœur d’une histoire vivante.',
    ...
    benefits: ['Spa & Wellness|Piscine intérieure de 25 mètres, hammams, sauna, vapeur, salles de repos et soins sélectionnés.', 'Fitness|Salle de sport premium, cardio et renforcement, accessible selon les horaires de l’établissement.', 'Hospitality|Restaurants, Gallada, rendez-vous privés, moments de représentation et demandes accompagnées.', 'Privilèges membres|Soins de 90 minutes, cours privés, Abelia Pool, valet et avantages selon disponibilité.'],
  ...
  en: {
    ...
    join: 'Apply for membership', back: 'Back to Bosphoras', why: 'Why this address', memory: 'The best view in Istanbul is not only a view. It is a memory.', whyText: 'From Karaköy, the eye crosses centuries: Galata, trade routes, Byzantium, Constantinople, the Ottoman conquest and contemporary Istanbul.',
    choiceLabel: 'The Bosphoras choice', choiceTitle: 'Be part of Istanbul, not just a visitor.', choiceText1: 'We did not choose The Peninsula only for its comfort. We selected it because it stands in Karaköy, old Galata, facing the historic peninsula, between the Golden Horn and the Bosphorus.', choiceText2: 'From this shore, one understands why Istanbul attracted Romans, Byzantines, Genoese, Ottomans, merchants, ambassadors and world powers. For a Bosphoras member, this address becomes an anchor inside a living history.',
    ...
    benefits: ['Spa & Wellness|25-metre indoor pool, hammams, sauna, steam rooms, relaxation areas and selected treatments.', 'Fitness|Premium gym, cardio and strength training, accessible according to the venue schedule.', 'Hospitality|Restaurants, Gallada, private meetings, representation moments and coordinated requests.', 'Member privileges|90-minute treatments, private classes, Abelia Pool, valet and benefits subject to availability.'],
  ...
  ru: {
    ...
    join: 'Подать заявку на членство', back: 'Вернуться к Bosphoras', why: 'Почему этот адрес', memory: 'Лучший вид на Стамбул — это не просто вид. Это память.', whyText: 'Из Каракёя взгляд проходит сквозь века: Галата, торговые пути, Византия, Константинополь, османское завоевание и современный Стамбул.',
    choiceLabel: 'Выбор Bosphoras', choiceTitle: 'Стать частью Стамбула, а не просто остановиться в нём.', choiceText1: 'Мы выбрали Peninsula не только за комфорт. Этот адрес находится в Каракёе, старой Галате, напротив исторического полуострова, между Золотым Рогом и Босфором.', choiceText2: 'С этого берега понятно, почему Стамбул веками притягивал римлян, византийцев, генуэзцев, османов, купцов, послов и мировые державы. Для участника Bosphoras этот адрес становится точкой опоры внутри живой истории.',
    ...
    benefits: ['Spa & Wellness|25-метровый крытый бассейн, хаммамы, сауна, паровые зоны, зоны отдыха и выбранные процедуры.', 'Fitness|Premium-зал, cardio и силовые тренировки согласно расписанию объекта.', 'Hospitality|Рестораны, Gallada, private meetings, представительские встречи и координируемые запросы.', 'Привилегии участников|Процедуры 90 минут, private classes, Abelia Pool, valet и преимущества при наличии доступности.'],
    ...
    cards: ['Karaköy · Galataport|Центральный адрес между историческим районом, современной набережной и видом на имперский полуостров.', 'Дискретность|Условия обсуждаются в рамках членских отношений и координируются офисом Bosphoras.', 'Bosphoras Premium|Привилегия, которая даёт реальное присутствие в одном из лучших адресов Стамбула.'],
  },
  ar: {
    ...
    join: 'طلب العضوية', back: 'العودة إلى Bosphoras', why: 'لماذا هذا العنوان', memory: 'أفضل إطلالة في إسطنبول ليست مجرد إطلالة. إنها ذاكرة.', whyText: 'من كاراكوي، يعبر النظر قروناً من التاريخ: غلطة، طرق التجارة، بيزنطة، القسطنطينية، الفتح العثماني وإسطنبول المعاصرة.',
    choiceLabel: 'اختيار Bosphoras', choiceTitle: 'أن تكون جزءاً من إسطنبول، لا مجرد زائر لها.', choiceText1: 'لم نختر Peninsula للراحة فقط. اخترناه لأنه يقع في كاراكوي، غلطة القديمة، مقابل شبه الجزيرة التاريخية، بين القرن الذهبي والبوسفور.', choiceText2: 'من هذا الضفة نفهم لماذا جذبت إسطنبول الرومان والبيزنطيين والجنويين والعثمانيين والتجار والسفراء وقوى العالم. بالنسبة لعضو Bosphoras، يصبح هذا العنوان نقطة ارتكاز داخل تاريخ حي.',
    ...
    benefits: ['Spa & Wellness|مسبح داخلي بطول 25 متراً، حمامات، ساونا، بخار، مناطق استراحة وعلاجات مختارة.', 'Fitness|نادي رياضي premium، cardio وتمارين قوة حسب أوقات المنشأة.', 'Hospitality|مطاعم، Gallada، اجتماعات خاصة، لحظات تمثيلية وطلبات منسقة.', 'امتيازات الأعضاء|علاجات 90 دقيقة، دروس خاصة، Abelia Pool، valet ومزايا حسب التوفر.'],
    ...
    cards: ['Karaköy · Galataport|عنوان مركزي بين الحي التاريخي والممشى المعاصر وإطلالة شبه الجزيرة الإمبراطورية.', 'الخصوصية|تتم معالجة الشروط ضمن علاقة العضوية وبتنسيق مكتب Bosphoras.', 'Bosphoras Premium|امتياز يمنح العضو حضوراً حقيقياً في أحد أفضل عناوين إسطنبول.'],
  },
} as const;

const img = { hero: '/images/vue.penincula.ciel.jpg', pool: '/images/Peninsula.pool.andwiew.jpg', historic: '/images/peninsula.pool.and.saint-sophie.jpg', interior: '/images/peninsula.interior.pool.jpg', hammam: '/images/peninsula.hammam.jpg', fitness: '/images/peninsula.fitness.jpg', lobby: '/images/peninsula.lobby.jpg', spa: '/images/waiting.area.spa.jpg', abelia: '/images/Abelia.Pool.Bar.jpg', logo: '/images/logo.Peninsula.Istanbul.Grey021.svg' };
  ...
  return (
    <>
      ...
      <main dir={rtl ? 'rtl' : 'ltr'} className="bg-[#f8f1e7] text-[#101827]">
        <section className="relative overflow-hidden bg-[#121826] pt-24 text-[#fffaf0] md:pt-36">
          <div className="absolute inset-0 bg-[linear-gradient(110deg,rgba(18,24,38,0.58)_0%,rgba(18,24,38,0.34)_45%,rgba(18,24,38,0.06)_100%),url('/images/vue.penincula.ciel.jpg')] bg-[length:auto_68%] bg-top bg-no-repeat md:bg-cover md:bg-center" />
          <div className="container-editorial relative z-10 grid min-h-[72vh] items-center gap-8 pb-14 pt-12 md:min-h-[82vh] lg:grid-cols-[0.95fr_1.05fr] lg:gap-12">
            <div className="max-w-3xl drop-shadow-[0_10px_28px_rgba(0,0,0,0.35)]">
              <img src={img.logo} alt="The Peninsula Istanbul" className="mb-7 h-10 w-auto brightness-0 invert drop-shadow-[0_4px_18px_rgba(0,0,0,0.55)] md:h-12" />
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <Link href={l.join} className="inline-flex items-center justify-center gap-3 bg-[#d2a863] px-8 py-4 text-xs font-bold uppercase tracking-[0.16em] text-[#101827] transition hover:bg-[#e0bc78]">{c.join}<ArrowRight size={15} /></Link>
                <Link href={l.home} className="inline-flex items-center justify-center border border-[#d2a863]/80 bg-[#121826]/35 px-8 py-4 text-xs font-bold uppercase tracking-[0.16em] text-[#ffe4ae] transition hover:bg-white/10">{c.back}</Link>
              </div>
            </div>
            <aside className="border border-[#d2a863]/45 bg-[#121826]/42 p-7 shadow-[0_28px_90px_rgba(0,0,0,0.20)] backdrop-blur-md md:p-9 lg:mt-44">
        ...
        <section className="px-5 py-20 md:px-8 md:py-28"><div className="mx-auto grid max-w-[1500px] gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:gap-24"><div><p className="mb-5 text-xs font-bold uppercase tracking-[0.3em] text-[#8a6728]">{c.choiceLabel}</p><h2 className="font-serif text-4xl leading-tight tracking-[-0.04em] md:text-6xl">{c.choiceTitle}</h2></div><div className="space-y-7 text-lg leading-9 text-[#3e4857]"><p>{c.choiceText1}</p><p>{c.choiceText2}</p></div></div></section>
        <section className="bg-[#fffaf0] px-5 py-20 md:px-8 md:py-28"><div className="mx-auto max-w-[1500px]"><div className="mb-12 max-w-4xl"><p className="text-xs font-bold uppercase tracking-[0.24em] text-[#8a6728]">{c.exp}</p><h2 className="mt-4 font-serif text-4xl tracking-[-0.035em] md:text-6xl">{c.expTitle}</h2></div><div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">{c.benefits.map((b, i) => { const [title, text] = b.split('|'); const Icon = icons[i]; return <article key={b} className="border border-[#d8c7a1] bg-white p-7 shadow-[0_18px_55px_rgba(16,24,39,0.045)]"><Icon className="h-8 w-8 text-[#8a6728]" strokeWidth={1.35} /><h3 className="mt-8 font-serif text-3xl text-[#121826]">{title}</h3><p className="mt-5 text-sm leading-7 text-[#3e4857]">{text}</p></article>; })}</div></div></section>
        <section className="px-5 py-20 md:px-8 md:py-28"><div className="mx-auto grid max-w-[1500px] overflow-hidden border border-[#d8c7a1] bg-[#121826] text-[#fffaf0] lg:grid-cols-[1.05fr_0.95fr]"><div className="p-8 md:p-12 lg:p-16"><p className="text-xs font-bold uppercase tracking-[0.28em] text-[#d2a863]">{c.frame}</p><h2 className="mt-6 font-serif text-4xl leading-tight tracking-[-0.04em] md:text-6xl">{c.frameTitle}</h2><div className="mt-8 grid gap-3 text-sm leading-7 text-[#f3e4c7] sm:grid-cols-2">{c.rules.map((rule) => <div key={rule} className="border border-[#d2a863]/25 p-4"><ShieldCheck className="mb-4 h-5 w-5 text-[#d2a863]" strokeWidth={1.35} /><p>{rule}</p></div>)}</div></div><div className="min-h-[360px] bg-[linear-gradient(135deg,rgba(18,24,38,0.08),rgba(18,24,38,0.34)),url('/images/peninsula.interior.pool.jpg')] bg-cover bg-center md:min-h-[420px]" /></div></section>
        ...
        <section className="px-5 py-20 md:px-8 md:py-28"><div className="mx-auto grid max-w-[1500px] gap-10 lg:grid-cols-3">{c.cards.map((card, i) => { const [title, text] = card.split('|'); const Icon = i === 0 ? MapPin : i === 1 ? Lock : Sparkles; return <article key={card} className="border border-[#d8c7a1] bg-white p-8"><Icon className="mb-8 h-8 w-8 text-[#8a6728]" strokeWidth={1.35} /><h3 className="font-serif text-3xl text-[#121826]">{title}</h3><p className="mt-5 text-sm leading-7 text-[#3e4857]">{text}</p></article>; })}</div></section>
