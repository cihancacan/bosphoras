    ...
    <>
      ...
      <main dir={rtl ? 'rtl' : 'ltr'} className="bg-[#f8f1e7] text-[#101827]">
        <section className="relative overflow-hidden bg-[#121826] pt-24 text-[#fffaf0] md:pt-36">
          <div className="absolute inset-0 bg-[linear-gradient(110deg,rgba(18,24,38,0.48)_0%,rgba(18,24,38,0.30)_42%,rgba(18,24,38,0.12)_100%),url('/images/vue.penincula.ciel.jpg')] bg-[length:auto_62%] bg-top bg-no-repeat md:bg-cover md:bg-center" />
          <div className="absolute inset-0 bg-[#6f7378]/18" />
          <div className="container-editorial relative z-10 grid min-h-[72vh] items-start gap-8 pb-12 pt-10 md:min-h-[82vh] md:pt-14 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12">
            <div className="max-w-3xl drop-shadow-[0_10px_28px_rgba(0,0,0,0.38)]">
              <img src={img.logo} alt="The Peninsula Istanbul" className="mb-7 h-10 w-auto brightness-0 invert drop-shadow-[0_4px_18px_rgba(0,0,0,0.60)] md:h-12" />
              ...
              <div className="mt-9 flex flex-row flex-wrap gap-3">
                <Link href={l.join} className="inline-flex items-center justify-center gap-3 bg-[#d2a863] px-6 py-3 text-[0.62rem] font-bold uppercase tracking-[0.12em] text-[#101827] transition hover:bg-[#e0bc78] md:px-8 md:py-4 md:text-xs md:tracking-[0.16em]">{c.join}<ArrowRight size={15} /></Link>
                <Link href={l.home} className="inline-flex items-center justify-center border border-[#d2a863]/80 bg-[#121826]/35 px-6 py-3 text-[0.62rem] font-bold uppercase tracking-[0.12em] text-[#ffe4ae] transition hover:bg-white/10 md:px-8 md:py-4 md:text-xs md:tracking-[0.16em]">{c.back}</Link>
              </div>
            </div>
            <aside className="border border-[#d2a863]/45 bg-[#121826]/42 p-7 shadow-[0_28px_90px_rgba(0,0,0,0.22)] backdrop-blur-md md:p-9 lg:mt-36">
