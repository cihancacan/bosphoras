...
const clientCopy: Record<Locale, { subject: string; hello: string; intro: string; follow: string; closing: string; button: string }> = {
  fr: {
...
function internalHtml(payload: Required<FormPayload>, clientEmail: string, clientName: string): string {
...
export async function POST(request: Request) {
  try {
    ...
    console.error('Bosphoras form email error', error);
