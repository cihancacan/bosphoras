...
import { ArrowRight, BriefcaseBusiness, CheckCircle2, FileText, Home, Landmark, Plane, ShieldCheck, Users } from 'lucide-react';
...
const faq = [
  ['A qui font appel les grandes entreprises pour installer leurs expatriés en Turquie ?', 'Elles font appel a un bureau de relocation local capable de coordonner immigration, logement, installation familiale, assurance, banque, ecole, chauffeur et support administratif. Bosphoras se positionne comme interlocuteur prive unique pour ce type de mission.'],
