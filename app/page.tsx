    ...
    <>
      ...
      <main className="bg-[#f8f1e7] text-[#101827]">
        ...
        <section className="bg-[#fffaf0] px-5 py-20 md:px-8 md:py-28"><div className="mx-auto max-w-[1500px]"><div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:gap-10">
          ...
          <div className="order-2 border border-[#d8c7a1] bg-[#121826] p-8 text-[#fffaf0] shadow-[0_40px_120px_rgba(16,24,39,0.18)] md:p-10 lg:order-1 lg:col-start-1 lg:row-span-2"><p className="text-[0.62rem] font-bold uppercase tracking-[0.34em] text-[#d2a863]">Bosphoras Private Access</p><h2 className="mt-8 font-serif text-4xl leading-tight tracking-[-0.04em] md:text-6xl">Une seule adhésion. Un seul niveau de service.</h2><p className="mt-7 text-base leading-8 text-[#d8cfbf]">Pour certains clients, la Turquie ne se gère pas demande par demande. Elle se gère avec un accès permanent à un bureau privé, capable de filtrer, coordonner et activer les bons interlocuteurs avec discrétion.</p><div className="my-9 h-px bg-gradient-to-r from-transparent via-[#d2a863] to-transparent" /><div className="grid gap-5 sm:grid-cols-2"><div><p className="text-[0.62rem] uppercase tracking-[0.22em] text-[#d2a863]">Admission annuelle</p><p className="mt-2 font-serif text-4xl text-white">10 000 USD</p><p className="mt-2 text-xs leading-5 text-[#d8cfbf]">À régler à l’entrée du cycle membre.</p></div><div><p className="text-[0.62rem] uppercase tracking-[0.22em] text-[#d2a863]">+ Retainer mensuel</p><p className="mt-2 font-serif text-4xl text-white">1 000 USD</p><p className="mt-2 text-xs leading-5 text-[#d8cfbf]">Payé chaque mois en plus de l’admission annuelle.</p></div></div><p className="mt-7 text-sm leading-7 text-[#d8cfbf]">Première année : 10 000 USD d’admission + 1 000 USD par mois. Sur parrainage, recommandation ou validation du profil. Cycle de 12 mois à compter de la validation. Conditions révisables chaque année.</p><div className="mt-8 flex flex-col gap-3 sm:flex-row"><Link href="/adhesion/demande-membre" className="inline-flex items-center justify-center gap-3 bg-[#d2a863] px-7 py-4 text-xs font-bold uppercase tracking-[0.16em] text-[#101827] transition hover:bg-[#e0bc78]">Demander une adhésion<ArrowRight size={15} /></Link><Link href="/diagnostic-prive" className="inline-flex items-center justify-center border border-[#d2a863]/70 px-7 py-4 text-xs font-bold uppercase tracking-[0.16em] text-[#d2a863] transition hover:bg-white/5">Demande classique</Link></div></div>
          <div className="order-3 grid gap-4 md:grid-cols-2 lg:order-3 lg:col-start-2">{memberBenefits.map((item) => { const Icon = item.icon; return <article key={item.title} className="border border-[#d8c7a1] bg-white p-7 shadow-[0_18px_55px_rgba(16,24,39,0.045)]"><Icon className="h-7 w-7 text-[#8a6728]" strokeWidth={1.4} /><h3 className="mt-8 font-serif text-3xl text-[#121826]">{item.title}</h3><p className="mt-5 text-sm leading-7 text-[#3e4857]">{item.text}</p></article>; })}</div>
        </div></div></section>
