...
const replacements = [
  ...
  ['body: JSON.stringify({ pickup, dropoff: drop, mode, vehicleId: car.id, hours })', 'body: JSON.stringify({ pickup, dropoff: drop, mode: modeRef.current, vehicleId: car.id, hours, roundTrip: modeRef.current === \'transfer\' && roundTripRef.current })'],
  ['body: JSON.stringify({ pickup, dropoff: drop, mode, vehicleId: car.id, hours, roundTrip: mode === \'transfer\' && roundTrip })', 'body: JSON.stringify({ pickup, dropoff: drop, mode: modeRef.current, vehicleId: car.id, hours, roundTrip: modeRef.current === \'transfer\' && roundTripRef.current })'],
...
content = content.replace("  const [mode, setMode] = useState<Mode>('transfer');\n  const [roundTrip, setRoundTrip] = useState(false);\n  const isRoundTrip = mode === 'transfer' && roundTrip;\n  const [pickup, setPickup] = useState('');", "  const [mode, setMode] = useState<Mode>('transfer');\n  const [roundTrip, setRoundTrip] = useState(false);\n  const modeRef = useRef<Mode>('transfer');\n  const roundTripRef = useRef(false);\n  const isRoundTrip = mode === 'transfer' && roundTrip;\n  const [pickup, setPickup] = useState('');");
content = content.replace("  const [mode, setMode] = useState<Mode>('transfer');\n  const [roundTrip, setRoundTrip] = useState(false);\n  const modeRef = useRef<Mode>('transfer');\n  const roundTripRef = useRef(false);\n  const isRoundTrip = mode === 'transfer' && roundTrip;\n  const modeRef = useRef<Mode>('transfer');\n  const roundTripRef = useRef(false);", "  const [mode, setMode] = useState<Mode>('transfer');\n  const [roundTrip, setRoundTrip] = useState(false);\n  const modeRef = useRef<Mode>('transfer');\n  const roundTripRef = useRef(false);\n  const isRoundTrip = mode === 'transfer' && roundTrip;");
...
console.log('[transfer booking] roundTrip state is immediate through refs');
